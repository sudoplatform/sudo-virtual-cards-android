...
class SudoVirtualCardsCompleteFundingSourceTest(
    ...
    @Test
    fun `completeFundingSource() should return results when no error present`() =
        runBlocking<Unit> {
            val deferredResult =
    ...
    @Test
    fun `completeFundingSource() should throw when response is null`() =
        runBlocking<Unit> {
            val mockOperation: GraphQLOperation<String> = mock()
            whenever(
    ...
    @Test
    fun `completeFundingSource() should throw when a provisional funding source not found error occurs`() =
        runBlocking<Unit> {
            val errors =
                listOf(
    ...
    @Test
    fun `completeFundingSource() should throw when a funding source state error occurs`() =
        runBlocking<Unit> {
            val errors =
                listOf(
                    GraphQLResponse.Error(
    ...
    @Test
    fun `completeFundingSource() should throw when a funding source not setup error occurs`() =
        runBlocking<Unit> {
            val errors =
                listOf(
                    GraphQLResponse.Error(
    ...
    @Test
    fun `completeFundingSource() should throw when a completion data invalid error occurs`() =
        runBlocking<Unit> {
            val errors =
                listOf(
                    GraphQLResponse.Error(
    ...
    @Test
    fun `completeFundingSource() should throw when an unacceptable funding source error occurs`() =
        runBlocking<Unit> {
            val errors =
                listOf(
                    GraphQLResponse.Error(
    ...
    @Test
    fun `completeFundingSource() should throw when http error occurs`() =
        runBlocking<Unit> {
            val errors =
                listOf(
                    GraphQLResponse.Error(
    ...
    @Test
    fun `completeFundingSource() should throw when unknown error occurs`() =
        runBlocking<Unit> {
    ...
    @Test
    fun `completeFundingSource() should not block coroutine cancellation exception`() =
        runBlocking<Unit> {
            mockApiCategory.stub {
                on {
                    mockApiCategory.mutate<String>(
