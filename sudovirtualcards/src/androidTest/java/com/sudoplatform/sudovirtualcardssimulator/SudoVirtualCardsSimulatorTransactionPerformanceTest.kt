...
class SudoVirtualCardsSimulatorTransactionPerformanceTest : BaseTest() {
    ...
    @Test
    fun measureTimeToListManyTransactions() =
        runBlocking<Unit> {
            ...
            val fundingSource =
                measure(Step.CREATE_FUNDING_SOURCE) {
                    createFundingSource(vcClient, fundingSourceInput)
                }

            // Create a Sudo
            val sudo =
                measure(Step.CREATE_SUDO) {
