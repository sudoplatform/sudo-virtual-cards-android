...
class SudoVirtualCardsSimulatorClientIntegrationTest : BaseTest() {
    ...
    @Test
    fun getSimulatorMerchantsShouldReturnResults() =
        runBlocking {
    ...
    @Test
    fun getSimulatorConversionRatesShouldReturnResults() =
        runBlocking<Unit> {
            assumeTrue(apiKeyPresent())
            assumeTrue(isTransactionSimulatorAvailable())
    ...
    @Test
    fun simulateAuthorizationShouldSucceed() =
        runBlocking {
            assumeTrue(apiKeyPresent())
    ...
    @Test
    fun simulateIncrementalAuthorizationShouldSucceed() =
        runBlocking {
            assumeTrue(apiKeyPresent())
            assumeTrue(clientConfigPresent())
            assumeTrue(isTransactionSimulatorAvailable())
    ...
    @Test
    fun simulateDebitShouldSucceed() =
        runBlocking {
            assumeTrue(apiKeyPresent())
            assumeTrue(clientConfigPresent())
            assumeTrue(isTransactionSimulatorAvailable())
    ...
    @Test
    fun simulateRefundShouldSucceed() =
        runBlocking {
            assumeTrue(apiKeyPresent())
            assumeTrue(clientConfigPresent())
            assumeTrue(isTransactionSimulatorAvailable())
    ...
    @Test
    fun simulateAuthorizationShouldFailWithBogusCard() =
        runBlocking<Unit> {
            assumeTrue(apiKeyPresent())
            assumeTrue(isTransactionSimulatorAvailable())
    ...
    @Test
    fun simulateIncrementalAuthorizationShouldFailWithBogusAuthorization() =
        runBlocking<Unit> {
            assumeTrue(apiKeyPresent())
            assumeTrue(isTransactionSimulatorAvailable())
    ...
    @Test
    fun simulateDebitShouldFailWithBogusAuthorization() =
        runBlocking<Unit> {
            assumeTrue(apiKeyPresent())
            assumeTrue(isTransactionSimulatorAvailable())
    ...
    @Test
    fun simulateRefundShouldFailWithBogusDebit() =
        runBlocking<Unit> {
            assumeTrue(apiKeyPresent())
            assumeTrue(isTransactionSimulatorAvailable())
    ...
    @Test
    fun simulateReversalShouldFailWithBogusAuthorization() =
        runBlocking<Unit> {
            assumeTrue(apiKeyPresent())
            assumeTrue(isTransactionSimulatorAvailable())
    ...
    @Test
    fun authorizationExpiryExpiredAuthorizationShouldFail() =
        runBlocking<Unit> {
            assumeTrue(apiKeyPresent())
            assumeTrue(clientConfigPresent())
            assumeTrue(isTransactionSimulatorAvailable())
    ...
    @Test
    fun simulateAuthorizationExpiryShouldFailWithBogusAuthorization() =
        runBlocking<Unit> {
            assumeTrue(apiKeyPresent())
            assumeTrue(isTransactionSimulatorAvailable())
