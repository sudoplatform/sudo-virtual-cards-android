...
class ListTransactionsIntegrationTest : BaseIntegrationTest() {
    ...
    @Test
    fun listTransactionsByCardIdShouldReturnSingleTransactionListOutputResult() =
        runBlocking {
            ...
            val transactions =
                await.atMost(Duration.ofSeconds(40)) withPollInterval Duration.ofMillis(200) untilCallTo {
                    runBlocking {
    ...
    @Test
    fun listTransactionsByCardIdShouldReturnMultipleTransactionListOutputResult() =
        runBlocking {
            assumeTrue(isTransactionSimulatorAvailable())
            registerSignInAndEntitle()
            verifyTestUserIdentity()
    ...
    @Test
    fun listTransactionsByCardIdShouldRespectLimit() =
        runBlocking {
            assumeTrue(isTransactionSimulatorAvailable())
            registerSignInAndEntitle()
            verifyTestUserIdentity()
            ...
            val transactionsWithLimit =
                await.atMost(
                    Duration.ofSeconds(12),
                ) withPollInterval Duration.ofMillis(200) untilCallTo {
                    runBlocking {
    ...
    @Test
    fun listTransactionsByCardIdShouldReturnEmptyList() =
        runBlocking {
            assumeTrue(isTransactionSimulatorAvailable())
            registerSignInAndEntitle()
            verifyTestUserIdentity()
    ...
    @Test
    fun listTransactionsByCardIdAndTypeShouldReturnSingleTransactionListOutputResult() =
        runBlocking {
            assumeTrue(isTransactionSimulatorAvailable())
            registerSignInAndEntitle()
            verifyTestUserIdentity()
    ...
    @Test
    fun listTransactionsByCardIdAndTypeShouldReturnMultipleTransactionListOutputResult() =
        runBlocking {
            assumeTrue(isTransactionSimulatorAvailable())
            registerSignInAndEntitle()
            verifyTestUserIdentity()
    ...
    @Test
    fun listTransactionsByCardIdAndTypeShouldRespectLimit() =
        runBlocking {
            assumeTrue(isTransactionSimulatorAvailable())
            registerSignInAndEntitle()
            verifyTestUserIdentity()
    ...
    @Test
    fun listTransactionsByCardIdAndTypeShouldReturnEmptyList() =
        runBlocking {
            assumeTrue(isTransactionSimulatorAvailable())
            registerSignInAndEntitle()
            verifyTestUserIdentity()
            ...
            when (
                val transactions =
                    vcClient.listTransactionsByCardIdAndType(
                        cardId = card.id,
    ...
    @Test
    fun listTransactionsShouldReturnSingleTransactionListOutputResult() =
        runBlocking {
            assumeTrue(isTransactionSimulatorAvailable())
            registerSignInAndEntitle()
            verifyTestUserIdentity()
    ...
    @Test
    fun listTransactionsShouldReturnMultipleTransactionListOutputResult() =
        runBlocking {
            assumeTrue(isTransactionSimulatorAvailable())
    ...
    @Test
    fun listTransactionsShouldRespectLimit() =
        runBlocking {
            assumeTrue(isTransactionSimulatorAvailable())
            registerSignInAndEntitle()
            verifyTestUserIdentity()
    ...
    @Test
    fun listTransactionsShouldReturnEmptyList() =
        runBlocking {
            assumeTrue(isTransactionSimulatorAvailable())
            registerSignInAndEntitle()
            verifyTestUserIdentity()
