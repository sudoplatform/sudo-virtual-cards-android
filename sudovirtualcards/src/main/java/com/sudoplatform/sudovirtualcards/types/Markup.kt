 ...
 *
 * @property percent Floating point percentage amount applied in calculating total markup multiplied by 1000.
 * For example: 2990 for 2.99%. 1/1000th of a percent is the smallest granularity that can be represented.
 * @property flat Flat amount applied in calculating total markup in minor currency unit of billed currency in containing
 * transaction detail e.g. 31 for $0.31.
 * @property minCharge The minimum charge that will be made to the funding source. For example, if a small charge of $0.10
